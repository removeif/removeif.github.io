...
function loadIssueData() {
    setTimeout(function () { // 延迟1s执行，保证其余的先加载
        ...
        if (typeof Gitalk !== "function") {
            $.getScript("https://cdn.jsdelivr.net/gh/removeif/removeif.github.io@v2.2.4/js/gitalk.min.js", function () { });
        }
        console.clear();
...
function loadSelfGitalk() { //加载碎碎念
    if ($("#comment-container1").length <= 0) {
     ...
     // 碎碎念页面才会走到下面
    $.getScript("https://cdn.jsdelivr.net/gh/removeif/removeif.github.io@v2.2.4/js/gitalk_self.min.js", function () {
